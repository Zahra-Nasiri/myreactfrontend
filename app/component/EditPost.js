    ...
    <Page title='Edit Post'>
      ...
      <form className='mt-3' onSubmit={submitHandler}>
        <div className="form-group">
          ...
          {state.title.hasErrors && <div className="alert alert-danger samll liveValidateMessage">{state.title.message}</div>}
        </div>
        <div className="form-group">
          ...
          {state.body.hasErrors && <div className="alert alert-danger samll liveValidateMessage">{state.body.message}</div>}
        </div>
